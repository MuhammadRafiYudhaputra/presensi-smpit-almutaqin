...
<div class="card card-custom p-4 shadow-sm border-0 rounded-4">
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-6">
            <div class="card border rounded-4 p-4 h-100 bg-light bg-opacity-40 shadow-none">
                ...
                <form action="{{ route('admin.rekap.cetak') }}" method="GET" target="_blank">
                    ...
                    <div class="mb-4">
                        <label class="form-label fw-bold text-dark mb-1 small">Hari Efektif Masuk :</label>
                        <div class="input-group input-group-sm shadow-sm">
                            <input type="number" name="hari_efektif" class="form-control form-control-sm" value="21" min="1" max="31" required>
                            <span class="input-group-text bg-white text-muted small">Hari</span>
                        </div>
                    </div>

                    <!-- Tombol Action (Generate PDF Saja) -->
                    <button type="submit" name="format" value="pdf" class="btn btn-danger text-uppercase fw-bold rounded-pill py-2.5 w-100 shadow-sm d-flex align-items-center justify-content-center gap-2">
        ...
        <div class="col-lg-6">
            <div class="card border rounded-4 p-4 h-100 bg-light bg-opacity-40 shadow-none">
                ...
                <form action="{{ route('admin.rekap.cetak') }}" method="GET" target="_blank">
                    ...
                    <div class="mb-4">
                        <label class="form-label fw-bold text-dark mb-1 small">Hari Efektif Semester :</label>
                        <div class="input-group input-group-sm shadow-sm">
                            <input type="number" name="hari_efektif" class="form-control form-control-sm" value="108" min="1" max="180" required>
                            <span class="input-group-text bg-white text-muted small">Hari</span>
                        </div>
                    </div>
